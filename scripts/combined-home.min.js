...
!function(i,e,t,s){t.swipebox=function(s,o){var n={useCSS:!0,hideBarsDelay:3e3},a=this,r=t(s),d=(s=s).selector,l=t(d),p=void 0!==e.createTouch||"ontouchstart"in i||"onmsgesturechange"in i||navigator.msMaxTouchPoints,c=!!i.SVGSVGElement;a.settings={},a.init=function(){a.settings=t.extend({},n,o),l.click(function(i){i.preventDefault(),i.stopPropagation(),index=r.index(t(this)),u.target=t(i.target),u.init(index)})};var u={init:function(i){this.target.trigger("swipebox-start"),this.build(),this.openSlide(i),this.openImg(i),this.preloadImg(i+1),this.preloadImg(i-1)},build:function(){var e=this;if(t("body").append('<div id="swipebox-overlay">\t\t\t\t\t<div id="swipebox-slider"></div>\t\t\t\t\t<div id="swipebox-caption"></div>\t\t\t\t\t<div id="swipebox-action">\t\t\t\t\t\t<a id="swipebox-close"></a>\t\t\t\t\t\t<a id="swipebox-prev"></a>\t\t\t\t\t\t<a id="swipebox-next"></a>\t\t\t\t\t</div>\t\t\t</div>'),e.doCssTrans()&&(t("#swipebox-slider").css({"-webkit-transition":"left 0.4s ease","-moz-transition":"left 0.4s ease","-o-transition":"left 0.4s ease","-khtml-transition":"left 0.4s ease",transition:"left 0.4s ease"}),t("#swipebox-overlay").css({"-webkit-transition":"opacity 1s ease","-moz-transition":"opacity 1s ease","-o-transition":"opacity 1s ease","-khtml-transition":"opacity 1s ease",transition:"opacity 1s ease"}),t("#swipebox-action, #swipebox-caption").css({"-webkit-transition":"0.5s","-moz-transition":"0.5s","-o-transition":"0.5s","-khtml-transition":"0.5s",transition:"0.5s"})),c){var s=t("#swipebox-action #swipebox-close").css("background-image");s=s.replace("png","svg"),t("#swipebox-action #swipebox-prev,#swipebox-action #swipebox-next,#swipebox-action #swipebox-close").css({"background-image":s})}r.each(function(){t("#swipebox-slider").append('<div class="slide"></div>')}),e.setDim(),e.actions(),e.keyboard(),e.gesture(),e.animBars(),t(i).resize(function(){e.setDim()}).resize()},setDim:function(){var e={width:t(i).width(),height:i.innerHeight?i.innerHeight:t(i).height()};t("#swipebox-overlay").css(e)},supportTransition:function(){for(var i="transition WebkitTransition MozTransition OTransition msTransition KhtmlTransition".split(" "),t=0;t<i.length;t++)if(void 0!==e.createElement("div").style[i[t]])return i[t];return!1},doCssTrans:function(){if(a.settings.useCSS&&this.supportTransition())return!0},gesture:function(){if(p){var i=this,e=null,s={},o={},n=t("#swipebox-caption, #swipebox-action");n.addClass("visible-bars"),i.setTimeout(),t("body").bind("touchstart",function(i){return t(this).addClass("touching"),o=i.originalEvent.targetTouches[0],s.pageX=i.originalEvent.targetTouches[0].pageX,t(".touching").bind("touchmove",function(i){i.preventDefault(),i.stopPropagation(),o=i.originalEvent.targetTouches[0]}),!1}).bind("touchend",function(a){a.preventDefault(),a.stopPropagation(),(e=o.pageX-s.pageX)>=10?i.getPrev():e<=-10?i.getNext():n.hasClass("visible-bars")?(i.clearTimeout(),i.hideBars()):(i.showBars(),i.setTimeout()),t(".touching").off("touchmove").removeClass("touching")})}},setTimeout:function(){if(a.settings.hideBarsDelay>0){var e=this;e.clearTimeout(),e.timeout=i.setTimeout(function(){e.hideBars()},a.settings.hideBarsDelay)}},clearTimeout:function(){i.clearTimeout(this.timeout),this.timeout=null},showBars:function(){var i=t("#swipebox-caption, #swipebox-action");this.doCssTrans()?i.addClass("visible-bars"):(t("#swipebox-caption").animate({top:0},500),t("#swipebox-action").animate({bottom:0},500),setTimeout(function(){i.addClass("visible-bars")},1e3))},hideBars:function(){var i=t("#swipebox-caption, #swipebox-action");this.doCssTrans()?i.removeClass("visible-bars"):(t("#swipebox-caption").animate({top:"-50px"},500),t("#swipebox-action").animate({bottom:"-50px"},500),setTimeout(function(){i.removeClass("visible-bars")},1e3))},animBars:function(){var i=this,e=t("#swipebox-caption, #swipebox-action");e.addClass("visible-bars"),i.setTimeout(),t("#swipebox-slider").click(function(t){e.hasClass("visible-bars")||(i.showBars(),i.setTimeout())}),t("#swipebox-action").hover(function(){i.showBars(),e.addClass("force-visible-bars"),i.clearTimeout()},function(){e.removeClass("force-visible-bars"),i.setTimeout()})},keyboard:function(){var e=this;t(i).bind("keyup",function(i){i.preventDefault(),i.stopPropagation(),37==i.keyCode?e.getPrev():39==i.keyCode?e.getNext():27==i.keyCode&&e.closeSlide()})},actions:function(){var i=this;r.length<2?t("#swipebox-prev, #swipebox-next").hide():(t("#swipebox-prev").bind("click touchend",function(e){e.preventDefault(),e.stopPropagation(),i.getPrev(),i.setTimeout()}),t("#swipebox-next").bind("click touchend",function(e){e.preventDefault(),e.stopPropagation(),i.getNext(),i.setTimeout()})),t("#swipebox-close").bind("click touchend",function(e){e.preventDefault(),e.stopPropagation(),i.closeSlide()})},setSlide:function(i,e){e=e||!1;var s=t("#swipebox-slider");this.doCssTrans()?s.css({left:100*-i+"%"}):s.animate({left:100*-i+"%"}),t("#swipebox-slider .slide").removeClass("current"),t("#swipebox-slider .slide").eq(i).addClass("current"),this.setTitle(i),e&&s.fadeIn(),t("#swipebox-prev, #swipebox-next").removeClass("disabled"),0==i?t("#swipebox-prev").addClass("disabled"):i==r.length-1&&t("#swipebox-next").addClass("disabled")},openSlide:function(e){t("html").addClass("swipebox"),t(i).trigger("resize"),this.setSlide(e,!0)},preloadImg:function(i){var e=this;setTimeout(function(){e.openImg(i)},1e3)},openImg:function(i){if(i<0||i>=r.length)return!1;this.loadImg(r.eq(i).attr("href"),function(){t("#swipebox-slider .slide").eq(i).html(this)})},setTitle:function(i,e){t("#swipebox-caption").empty(),r.eq(i).attr("title")&&t("#swipebox-caption").append(r.eq(i).attr("title"))},loadImg:function(i,e){var s=t("<img>").on("load",function(){e.call(s)});s.attr("src",i)},getNext:function(){index=t("#swipebox-slider .slide").index(t("#swipebox-slider .slide.current")),index+1<r.length?(index++,this.setSlide(index),this.preloadImg(index+1)):(t("#swipebox-slider").addClass("rightSpring"),setTimeout(function(){t("#swipebox-slider").removeClass("rightSpring")},500))},getPrev:function(){index=t("#swipebox-slider .slide").index(t("#swipebox-slider .slide.current")),index>0?(index--,this.setSlide(index),this.preloadImg(index-1)):(t("#swipebox-slider").addClass("leftSpring"),setTimeout(function(){t("#swipebox-slider").removeClass("leftSpring")},500))},closeSlide:function(){t(i).trigger("resize"),t("html").removeClass("swipebox"),this.destroy()},destroy:function(){t(i).unbind("keyup"),t("body").unbind("touchstart"),t("body").unbind("touchmove"),t("body").unbind("touchend"),t("#swipebox-slider").unbind(),t("#swipebox-overlay").remove(),r.removeData("_swipebox"),this.target.trigger("swipebox-destroy")}};a.init()},t.fn.swipebox=function(i){if(!t.data(this,"_swipebox")){var e=new t.swipebox(this,i);this.data("_swipebox",e)}}}(window,document,jQuery);
...
(function(e,t){"use strict";var n=n||function(n){var a,s={element:null,dragger:null,disable:"right",addBodyClasses:!0,hyperextensible:!1,resistance:.5,flickThreshold:50,transitionSpeed:.3,easing:"ease-in-out",maxPosition:272,minPosition:0,tapToClose:!0,touchToDrag:!0,slideIntent:40,minDragDistance:5},r={simpleStates:{opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},i={},o={hasTouch:null===t.ontouchstart,eventType:function(e){return{down:o.hasTouch?"touchstart":"mousedown",move:o.hasTouch?"touchmove":"mousemove",up:o.hasTouch?"touchend":"mouseup",out:o.hasTouch?"touchcancel":"mouseout"}[e]},page:function(e,t){return o.hasTouch&&t.touches.length&&t.touches[0]?t.touches[0]["page"+e]:t["page"+e]},klass:{has:function(e,t){return-1!==e.className.indexOf(t)},add:function(e,t){!o.klass.has(e,t)&&s.addBodyClasses&&(e.className+=" "+t)},remove:function(e,t){s.addBodyClasses&&(e.className=e.className.replace(t,"").replace(/^\s+|\s+$/g,""))}},dispatchEvent:function(e){if("function"==typeof i[e])return i[e].call()},vendor:function(){var e,n=t.createElement("div"),a="webkit Moz O ms".split(" ");for(e in a)if(void 0!==n.style[a[e]+"Transition"])return a[e]},transitionCallback:function(){return"Moz"===r.vendor||"ms"===r.vendor?"transitionend":r.vendor+"TransitionEnd"},canTransform:function(){return void 0!==s.element.style[r.vendor+"Transform"]},deepExtend:function(e,t){var n;for(n in t)t[n]&&t[n].constructor&&t[n].constructor===Object?(e[n]=e[n]||{},o.deepExtend(e[n],t[n])):e[n]=t[n];return e},angleOfDrag:function(e,t){var n,a;return(a=Math.atan2(-(r.startDragY-t),r.startDragX-e))<0&&(a+=2*Math.PI),(n=Math.floor(a*(180/Math.PI)-180))<0&&n>-180&&(n=360-Math.abs(n)),Math.abs(n)},events:{addEvent:function(e,t,n){return e.addEventListener?e.addEventListener(t,n,!1):e.attachEvent?e.attachEvent("on"+t,n):void 0},removeEvent:function(e,t,n){return e.addEventListener?e.removeEventListener(t,n,!1):e.attachEvent?e.detachEvent("on"+t,n):void 0},prevent:function(e){e.preventDefault?e.preventDefault():e.returnValue=!1}},parentUntil:function(e,t){for(var n="string"==typeof t;e.parentNode;){if(n&&e.getAttribute&&e.getAttribute(t))return e;if(!n&&e===t)return e;e=e.parentNode}return null}},l={translate:{get:{matrix:function(t){if(o.canTransform()){var n=e.getComputedStyle(s.element)[r.vendor+"Transform"].match(/\((.*)\)/);return n?(16===(n=n[1].split(",")).length&&(t+=8),parseInt(n[t],10)):0}return parseInt(s.element.style.left,10)}},easeCallback:function(){s.element.style[r.vendor+"Transition"]="",r.translation=l.translate.get.matrix(4),r.easing=!1,clearInterval(r.animatingInterval),0===r.easingTo&&(o.klass.remove(t.body,"snapjs-right"),o.klass.remove(t.body,"snapjs-left")),o.dispatchEvent("animated"),o.events.removeEvent(s.element,o.transitionCallback(),l.translate.easeCallback)},easeTo:function(e){o.canTransform()?(r.easing=!0,r.easingTo=e,s.element.style[r.vendor+"Transition"]="all "+s.transitionSpeed+"s "+s.easing,r.animatingInterval=setInterval(function(){o.dispatchEvent("animating")},1),o.events.addEvent(s.element,o.transitionCallback(),l.translate.easeCallback),l.translate.x(e)):(r.translation=e,l.translate.x(e)),0===e&&(s.element.style[r.vendor+"Transform"]="")},x:function(n){if(!("left"===s.disable&&n>0||"right"===s.disable&&n<0))if(s.hyperextensible||(n===s.maxPosition||n>s.maxPosition?n=s.maxPosition:(n===s.minPosition||n<s.minPosition)&&(n=s.minPosition)),n=parseInt(n,10),isNaN(n)&&(n=0),o.canTransform()){var a="translate3d("+n+"px, 0,0)";s.element.style[r.vendor+"Transform"]=a}else s.element.style.width=(e.innerWidth||t.documentElement.clientWidth)+"px",s.element.style.left=n+"px",s.element.style.right=""}},drag:{listen:function(){r.translation=0,r.easing=!1,o.events.addEvent(s.element,o.eventType("down"),l.drag.startDrag),o.events.addEvent(s.element,o.eventType("move"),l.drag.dragging),o.events.addEvent(s.element,o.eventType("up"),l.drag.endDrag)},stopListening:function(){o.events.removeEvent(s.element,o.eventType("down"),l.drag.startDrag),o.events.removeEvent(s.element,o.eventType("move"),l.drag.dragging),o.events.removeEvent(s.element,o.eventType("up"),l.drag.endDrag)},startDrag:function(e){var t=e.target?e.target:e.srcElement;if(o.parentUntil(t,"data-snap-ignore"))o.dispatchEvent("ignore");else{if(s.dragger)if(!o.parentUntil(t,s.dragger)&&r.translation!==s.minPosition&&r.translation!==s.maxPosition)return;o.dispatchEvent("start"),s.element.style[r.vendor+"Transition"]="",r.isDragging=!0,r.hasIntent=null,r.intentChecked=!1,r.startDragX=o.page("X",e),r.startDragY=o.page("Y",e),r.dragWatchers={current:0,last:0,hold:0,state:""},r.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}}},dragging:function(e){if(r.isDragging&&s.touchToDrag){var n=o.page("X",e),a=o.page("Y",e),i=r.translation,d=l.translate.get.matrix(4),c=n-r.startDragX,g=d>0,h=c;if(r.intentChecked&&!r.hasIntent)return;if(s.addBodyClasses&&(d>0?(o.klass.add(t.body,"snapjs-left"),o.klass.remove(t.body,"snapjs-right")):d<0&&(o.klass.add(t.body,"snapjs-right"),o.klass.remove(t.body,"snapjs-left"))),!1===r.hasIntent||null===r.hasIntent){var p=o.angleOfDrag(n,a),m=p>=0&&p<=s.slideIntent||p<=360&&p>360-s.slideIntent,u=p>=180&&p<=180+s.slideIntent||p<=180&&p>=180-s.slideIntent;r.hasIntent=!(!u&&!m),r.intentChecked=!0}if(s.minDragDistance>=Math.abs(n-r.startDragX)||!1===r.hasIntent)return;o.events.prevent(e),o.dispatchEvent("drag"),r.dragWatchers.current=n,r.dragWatchers.last>n?("left"!==r.dragWatchers.state&&(r.dragWatchers.state="left",r.dragWatchers.hold=n),r.dragWatchers.last=n):r.dragWatchers.last<n&&("right"!==r.dragWatchers.state&&(r.dragWatchers.state="right",r.dragWatchers.hold=n),r.dragWatchers.last=n),g?(s.maxPosition<d&&(h=c-(d-s.maxPosition)*s.resistance),r.simpleStates={opening:"left",towards:r.dragWatchers.state,hyperExtending:s.maxPosition<d,halfway:d>s.maxPosition/2,flick:Math.abs(r.dragWatchers.current-r.dragWatchers.hold)>s.flickThreshold,translation:{absolute:d,relative:c,sinceDirectionChange:r.dragWatchers.current-r.dragWatchers.hold,percentage:d/s.maxPosition*100}}):(s.minPosition>d&&(h=c-(d-s.minPosition)*s.resistance),r.simpleStates={opening:"right",towards:r.dragWatchers.state,hyperExtending:s.minPosition>d,halfway:d<s.minPosition/2,flick:Math.abs(r.dragWatchers.current-r.dragWatchers.hold)>s.flickThreshold,translation:{absolute:d,relative:c,sinceDirectionChange:r.dragWatchers.current-r.dragWatchers.hold,percentage:d/s.minPosition*100}}),l.translate.x(h+i)}},endDrag:function(e){if(r.isDragging){o.dispatchEvent("end");var t=l.translate.get.matrix(4);if(0===r.dragWatchers.current&&0!==t&&s.tapToClose)return o.dispatchEvent("close"),o.events.prevent(e),l.translate.easeTo(0),r.isDragging=!1,void(r.startDragX=0);"left"===r.simpleStates.opening?r.simpleStates.halfway||r.simpleStates.hyperExtending||r.simpleStates.flick?r.simpleStates.flick&&"left"===r.simpleStates.towards?l.translate.easeTo(0):(r.simpleStates.flick&&"right"===r.simpleStates.towards||r.simpleStates.halfway||r.simpleStates.hyperExtending)&&l.translate.easeTo(s.maxPosition):l.translate.easeTo(0):"right"===r.simpleStates.opening&&(r.simpleStates.halfway||r.simpleStates.hyperExtending||r.simpleStates.flick?r.simpleStates.flick&&"right"===r.simpleStates.towards?l.translate.easeTo(0):(r.simpleStates.flick&&"left"===r.simpleStates.towards||r.simpleStates.halfway||r.simpleStates.hyperExtending)&&l.translate.easeTo(s.minPosition):l.translate.easeTo(0)),r.isDragging=!1,r.startDragX=o.page("X",e)}}}};this.open=function(e){o.dispatchEvent("open"),o.klass.remove(t.body,"snapjs-expand-left"),o.klass.remove(t.body,"snapjs-expand-right"),"left"===e?(r.simpleStates.opening="left",r.simpleStates.towards="right",o.klass.add(t.body,"snapjs-left"),o.klass.remove(t.body,"snapjs-right"),l.translate.easeTo(s.maxPosition)):"right"===e&&(r.simpleStates.opening="right",r.simpleStates.towards="left",o.klass.remove(t.body,"snapjs-left"),o.klass.add(t.body,"snapjs-right"),l.translate.easeTo(s.minPosition))},this.close=function(){o.dispatchEvent("close"),l.translate.easeTo(0)},this.expand=function(n){var a=e.innerWidth||t.documentElement.clientWidth;"left"===n?(o.dispatchEvent("expandLeft"),o.klass.add(t.body,"snapjs-expand-left"),o.klass.remove(t.body,"snapjs-expand-right")):(o.dispatchEvent("expandRight"),o.klass.add(t.body,"snapjs-expand-right"),o.klass.remove(t.body,"snapjs-expand-left"),a*=-1),l.translate.easeTo(a)},this.on=function(e,t){return i[e]=t,this},this.off=function(e){i[e]&&(i[e]=!1)},this.enable=function(){o.dispatchEvent("enable"),l.drag.listen()},this.disable=function(){o.dispatchEvent("disable"),l.drag.stopListening()},this.settings=function(e){o.deepExtend(s,e)},this.state=function(){var e=l.translate.get.matrix(4);return{state:e===s.maxPosition?"left":e===s.minPosition?"right":"closed",info:r.simpleStates}},(a=n).element&&(o.deepExtend(s,a),r.vendor=o.vendor(),l.drag.listen())};"undefined"!=typeof module&&module.exports&&(module.exports=n),"undefined"==typeof ender&&(this.Snap=n),"function"==typeof define&&define.amd&&define("snap",[],function(){return n})}).call(this,window,document);
$(document).ready(function(){$(".submenu-deploy").click(function(){window.location.href="/gallery.php"}),$(".submenu-deploy+span").click(function(e){return e.stopPropagation(),$(this).parent().find(".nav-submenu").toggle(100),$(this).parent().find(".sidebar-decoration").toggle(100),$(this).find("em").toggleClass("dropdown-item"),!1}),$(".wide-image a").click(function(){$(this).parent().parent().find(".wide-active").toggle(100)}),$(".update-button").click(function(){$(this).parent().find(".page-update-text").toggle(100),$(this).parent().find(".update-icon").toggleClass("active-update-icon")}),$(".style-changer").click(function(){return!1}),$(".close-nav, .sidebar-close, .shortcut-close").click(function(){e.close()}),$(".shortcut-search").click(function(){$(".sidebar-shortcuts").hide(),$(".sidebar-search").show()}),$(".search-close").click(function(){$(".sidebar-search").hide(),$(".sidebar-shortcuts").show()}),$(".open-nav").click(function(){return"left"==e.state().state?e.close():e.open("left"),!1}),$(".wide-image").click(function(){return $(this).parent().find(".wide-item-content").toggle(50),!1});var e=new Snap({element:document.getElementById("content")});$(".deploy-sidebar").click(function(){return"left"==e.state().state?e.close():e.open("left"),!1})});
$(document).ready(function(){$(".goup-footer").click(function(){return $("body,html").animate({scrollTop:0},800,"easeOutExpo"),!1}),$(".checkbox-one").click(function(){return $(this).toggleClass("checkbox-one-checked"),!1}),$(".checkbox-two").click(function(){return $(this).toggleClass("checkbox-two-checked"),!1}),$(".checkbox-three").click(function(){return $(this).toggleClass("checkbox-three-checked"),!1}),$(".radio-one").click(function(){return $(this).toggleClass("radio-one-checked"),!1}),$(".radio-two").click(function(){return $(this).toggleClass("radio-two-checked"),!1}),$(".tap-dismiss-notification").click(function(){return $(this).fadeOut(),!1}),$(".close-big-notification").click(function(){return $(this).parent().fadeOut(),!1}),$(".tab-but-1").click(function(){return $(".tab-but").removeClass("tab-active"),$(".tab-but-1").addClass("tab-active"),$(".tab-content").hide(100),$(".tab-content-1").show(100),!1}),$(".tab-but-2").click(function(){return $(".tab-but").removeClass("tab-active"),$(".tab-but-2").addClass("tab-active"),$(".tab-content").hide(100),$(".tab-content-2").show(100),!1}),$(".tab-but-3").click(function(){return $(".tab-but").removeClass("tab-active"),$(".tab-but-3").addClass("tab-active"),$(".tab-content").hide(100),$(".tab-content-3").show(100),!1}),$(".tab-but-4").click(function(){return $(".tab-but").removeClass("tab-active"),$(".tab-but-4").addClass("tab-active"),$(".tab-content").hide(100),$(".tab-content-4").show(100),!1}),$(".tab-but-5").click(function(){return $(".tab-but").removeClass("tab-active"),$(".tab-but-5").addClass("tab-active"),$(".tab-content").hide(100),$(".tab-content-5").show(100),!1}),$(".deploy-toggle-1").click(function(){return $(this).parent().find(".toggle-content").toggle(100),$(this).toggleClass("toggle-1-active"),!1}),$(".deploy-toggle-2").click(function(){return $(this).parent().find(".toggle-content").toggle(100),$(this).toggleClass("toggle-2-active"),!1}),$(".deploy-toggle-3").click(function(){return $(this).parent().find(".toggle-content").toggle(100),$(this).find("em strong").toggleClass("toggle-3-active-ball"),$(this).find("em").toggleClass("toggle-3-active-background"),!1}),$(".submenu-nav-deploy").click(function(){return $(this).toggleClass("submenu-nav-deploy-active"),$(this).parent().find(".submenu-nav-items").toggle(100),!1}),$(".sliding-door-top").click(function(){return $(this).animate({left:"101%"},500,"easeInOutExpo"),!1}),$(".sliding-door-bottom a em").click(function(){return $(this).parent().parent().parent().find(".sliding-door-top").animate({left:"0px"},500,"easeOutBounce"),!1});var t=navigator.userAgent.toLowerCase().indexOf("iphone"),e=navigator.userAgent.toLowerCase().indexOf("ipad"),o=navigator.userAgent.toLowerCase().indexOf("ipod"),i=navigator.userAgent.toLowerCase().indexOf("android");t>-1&&($(".ipod-detected").hide(),$(".ipad-detected").hide(),$(".iphone-detected").show(),$(".android-detected").hide()),e>-1&&($(".ipod-detected").hide(),$(".ipad-detected").show(),$(".iphone-detected").hide(),$(".android-detected").hide()),o>-1&&($(".ipod-detected").show(),$(".ipad-detected").hide(),$(".iphone-detected").hide(),$(".android-detected").hide()),i>-1&&($(".ipod-detected").hide(),$(".ipad-detected").hide(),$(".iphone-detected").hide(),$(".android-detected").show())});
$(window).load(function(){$("#status").fadeOut(),$("#preloader").delay(350).fadeOut("slow")}),$(document).ready(function(){!function(e,t,i){if(i in t&&t[i]){var o,n=e.location,r=/^(a|html)$/i;e.addEventListener("click",function(e){for(o=e.target;!r.test(o.nodeName);)o=o.parentNode;"href"in o&&(o.href.indexOf("http")||~o.href.indexOf(n.host))&&(e.preventDefault(),n.href=o.href)},!1)}}(document,window.navigator,"standalone");var e=$(".slider-controls");e.owlCarousel({singleItem:!0,slideSpeed:250,paginationSpeed:250,rewindSpeed:250,pagination:!1,autoPlay:!0}),$(".next-slider").click(function(){return e.trigger("owl.next"),!1}),$(".prev-slider").click(function(){return e.trigger("owl.prev"),!1});var t=$(".quote-slider");t.owlCarousel({items:2,itemsDesktop:[1199,4],itemsDesktopSmall:[980,3],itemsTablet:[768,3],itemsTabletSmall:[330,1],itemsMobile:[320,1],singleItem:!1,itemsScaleUp:!1,slideSpeed:250,paginationSpeed:250,rewindSpeed:250,pagination:!1,autoPlay:!1,autoHeight:!0}),$(".quote-slider-no-controls").owlCarousel({singleItem:!0,slideSpeed:250,paginationSpeed:250,rewindSpeed:250,pagination:!1,autoPlay:!0,autoHeight:!0}),$(".next-quote").click(function(){return t.trigger("owl.next"),!1}),$(".prev-quote").click(function(){return t.trigger("owl.prev"),!1}),$(".slider-two-thumbs").owlCarousel({singleItem:!0}),$(".slider-no-controls").owlCarousel({singleItem:!0,slideSpeed:250,paginationSpeed:250,rewindSpeed:250,pagination:!1,autoHeight:!0,autoPlay:!0,stopOnHover:!0,dragBeforeAnimFinish:!0,mouseDrag:!0,touchDrag:!0,transitionStyle:!1}),$(".swipebox").swipebox({useCSS:!0,hideBarsDelay:3e3}),$(".swipebox-wide").swipebox({useCSS:!0,hideBarsDelay:3e3}),$(".portfolio-item-full-width a").colorbox({transition:"fade",scalePhotos:"true",maxWidth:"100%",maxHeight:"100%"}),$(".portfolio-item-thumb a").colorbox({transition:"fade",scalePhotos:"true",maxWidth:"100%",maxHeight:"100%"});var i,o,n,r,a,l,s=7;function d(){l=0,r=!1,a=setInterval(u,10)}function u(){!1===r&&(l+=1/s,o.css({width:l+"%"}),l>=100&&n.trigger("owl.next"))}$(".homepage-slider").owlCarousel({slideSpeed:500,paginationSpeed:500,singleItem:!0,pagination:!1,afterInit:function(e){n=e,i=$("<div>",{id:"progressBar"}),o=$("<div>",{id:"bar"}),i.append(o).prependTo(n),d()},afterMove:function(){clearTimeout(a),d()},startDragging:function(){r=!0}}),$(".next-home").click(function(){return $(".homepage-slider").trigger("owl.next"),!1}),$(".prev-home").click(function(){return $(".homepage-slider").trigger("owl.prev"),!1})});
...
jQuery(document).ready(function(){dialog=new DialogBox("covid-popup"),dialog.showDialog()});